  ...
  <div class="modal-dialog" >
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Add New Test Vendor</h4>
      ...
      <div class="modal-body">
         <form action="" method="post" class="col-12 form shadow-lg p-5 ">
          ...
          <input type="text" class="form-control text-uppercase" placeholder="Enter Name" name="vName">
          </div>
...
<?php
  if(isset($_POST['submit'])){
    $vName=$_POST['vName'];
    $sql="INSERT INTO `vendor`(`vendor_name`) VALUES ('$vName')";
           ...
           <table class="table table-striped table-hover" id="myTable">
            ...
            <tbody>
              <?php
                ...
                $offset=($page-1)*$limit;
                $que="select *from vendor order by vendor_id desc limit {$offset}, {$limit}";
              ...
              <tr>
                ...
                <td>
                  <form action="editvendor.php" method="post">
                   <input type="hidden" name="dEditID" value="<?php echo $row['vendor'];?>">
          ...
          <?php
              ...
              if(mysqli_num_rows($r)>0){
                ...
                for($i=1; $i<=$totalPages; $i++){
                  echo '<li class="page-item"><a class="page-link" href="testVendor.php?page='.$i.'">'.$i.'</a></li>';
              }
              echo '</ul>';
                }
          ?>
